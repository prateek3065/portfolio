...
import WithOnScrollAppear from "../../common/section-intro-text/client/on-scroll-opacity-scaling/on-scroll-opacity-scaling";
...
const RecommendationCard: React.FC<RecommendationCardProps> = (props) => {
  return (
    <WithOnScrollAppear>
      <Card>
        <div className="flex gap-2 bg-white p-3 px-3 pb-6 rounded-3xl shadow-md max-w-[95vw] lg:max-w-[28rem] relative">
